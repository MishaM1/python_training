...
import unittest
from python_training.contacts import Contact
...
class new_user(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(first_name="Misha", last_name="New", address="New York",
    ...
    def test_add_empty_contact(self):
        ...
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.create_contact(wd, Contact(first_name="", last_name="", address="", home_phone="", mobile_phone="",
